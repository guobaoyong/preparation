package qqzsh.top.preparation.common.utils.aliyun;
 ...
 * @create020-02-18 19:17
 * @Description 阿里云文本反垃圾
 */
@Slf4j
public class AliyunTextScanRequest {
     ...
     * @throws Exception
     */
    public static String textScanRequest(String content,String accessKey,String secret) throws Exception {
