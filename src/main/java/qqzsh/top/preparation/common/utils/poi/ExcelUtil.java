package qqzsh.top.preparation.common.utils.poi;
...
import qqzsh.top.preparation.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    {
        String downloadPath = PreparationConfig.getDownloadPath() + filename;
